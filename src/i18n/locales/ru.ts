export const ruTranslations = {
	...
	styx: 'Styx Cash — это финтех-компания, специализирующаяся на легальных способах вывода денежных средств с кредитных карт и конвертации криптовалюты в фиат (наличные).',
	...
	use: '— Использовать созданный личный счёт в системе Styx Cash для хранения, управления или обналичивания средств.',
	personal: 'Персональный кабинет в системе Styx Cash;',
	...
	'styx helps':
		'Styx Cash помогает использовать кредитные средства правильно, а не создаёт долг.',
	'not simple':
